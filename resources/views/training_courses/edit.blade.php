 ...
 @section('content')
     ...
     <div class="col-md-12">
         <form method="POST"  action="{{ route('training_courses.update',$data['id']) }}" role="form"
             ...
             <div class="card-body">
                 ...
                 <div class="form-group">
                     ...
                     <input  type="date" name="end_data" class="form-control" id="end_data" value="{{ old('end_data',$data['end_data']) }}">
                     @error('end_data')
                         <span style="color: red">{{ $message }}</span>
                     @enderror
                     </div>
                 ...
                 <div class="form-group" style="text-align: center">
                     <button type="submit" style="margin-right:" class="btn btn-primary">تحديث الدورة التدريبية</button>
                 </div>
             </div>
