        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="text-align: center; float:none"> بيانات الطلاب
                    ...
                    <a class="btn btn-sm btn-info " href="{{ route('student.create') }}">{{ __('mycustom.ADDNAM') }}</a>
                    {{-- <a class="btn btn-sm btn-info " href="{{ route('student.create') }}"> اضافة جديد</a> --}}
                </h3>
  ...
  height: 70px;" src="{{asset('uploads/'.$info->image)}}"  > </td>
                                    ...
                                    <th style="width: 15%">
                                        <a href="{{ route('student.edit', $info->id) }}" class="button"
                                            style="background-color: #04AA6D; color:white;  padding:5px; font-weight: normal">
                                            تعديل</a>
                                        <a href="{{ route('student.destroy', $info->id) }}" class="button"
                                            style="background-color: #aa0704; color:white; padding:5px;   font-weight: normal">
                                            حذف </a>
                                    </th>
                                </tr>
                            @endforeach
