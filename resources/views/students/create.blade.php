 ...
 @section('content')
     ...
     <div class="col-md-12">
         <form method="POST" enctype="multipart/form-data" action="{{ route('student.store') }}" role="form"
             ...
             <div class="card-body">
                 ...
                 <div class="form-group" style="text-align: center">
                     <button type="submit" style="margin-right: " class="btn btn-primary">اضف الطالب</button>
                 </div>
             </div>
