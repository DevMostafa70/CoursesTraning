...
@endif
     ...
     <div class="col-md-12">
         <form method="POST" action="{{ route('courses.update',$data['id']) }}" role="form" style="width: 80%; margin: 0 auto;background-color: white">
            @csrf
             <div class="card-body">
                 ...
                 <div class="form-group" style="text-align: center">
                     <button type="submit" style="margin-right: " class="btn btn-primary">تحديث الكورس</button>
                 </div>
             </div>
